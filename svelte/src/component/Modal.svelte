<script>
    ...
    let isModalPopup = "hidden"
    const handleModalPopUp_Open = () => {
        isModalPopup = "flex justify-center items-center"
    }
...
<div id="defaultModal" tabindex="-1" aria-hidden="true" class="{isModalPopup} overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full">
    <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <!-- Modal body -->
            <div class="p-6 space-y-6 {modal_body_css}">
