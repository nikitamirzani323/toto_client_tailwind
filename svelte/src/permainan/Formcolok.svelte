	...
	function addKeranjang(
  	...
  	const removekeranjang = (e) => {
		...
		switch(e.detail.permainan){
			case "COLOK_BEBAS":
				sum_colokbebas = sum_colokbebas - e.detail.bayar;
				break;
			case "COLOK_MACAU":
				sum_colokmacau = sum_colokmacau - e.detail.bayar;
				break;
			case "COLOK_NAGA":
				sum_coloknaga = sum_coloknaga - e.detail.bayar;
				break;
			case "COLOK_JITU":
				sum_colokjitu = sum_colokjitu - e.detail.bayar;
				break;
		}
	};
      	...
      	{:else}
			...
			{:else}
				...
				<label for="my-modal-inputbet" 
					class="modal-button font-semibold text-center text-xs m-2 h-[3rem] bg-base-200 rounded-md outline outline-1 outline-offset-1 outline-green-600 ">
