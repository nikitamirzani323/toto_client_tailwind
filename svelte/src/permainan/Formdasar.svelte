      ...
      {#if client_device == "WEBSITE"}
		...
		<div class="mt-1 gap-2 grid grid-cols-2">
			...
			<div class="form-control">
				...
				<label class="label">
					<span class="label-text text-sm">&nbsp;</span>
					<span class="label-text-alt text-sm">{new Intl.NumberFormat().format(bet_dasar)}</span>
				</label>
			</div>
		</div>
		...
		<div class="modal modal-bottom sm:modal-middle">
			<div class="modal-box bg-base-200 relative rounded-sm">
				...
				<div class="form-control">
					...
					<label class="label">
						<span class="label-text text-xs">&nbsp;</span>
						<span class="label-text-alt text-xs">{new Intl.NumberFormat().format(bet_dasar)}</span>
					</label>
				</div>
				<div class="form-control ">
					<Button_custom1 
