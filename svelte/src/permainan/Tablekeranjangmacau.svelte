<script>
    ...
    export let sum_line_macaukombinasi = 0;
    ...
    $: {
        count_line = count_line_macaukombinasi;
        sum_line = sum_line_macaukombinasi;
    }
            ...
            {#if panel_line}
                <div class="bg-base-300 shadow-lg p-2">
                    ...
                    <div class="grid grid-cols-1">
                        <div class="basis-1/4 text-xs">MACAU KOMBINASI : <span class="text-sm link-accent">{count_line_macaukombinasi}</span></div>
                    </div>
                </div>
            {/if}
            {#if panel_sum}
                <div class="bg-base-300 shadow-lg p-2">
                    ...
                    <div class="grid grid-cols-1">
                        <div class="basis-1/4 text-xs">MACAU KOMBINASI : <span class="text-sm link-accent">{new Intl.NumberFormat().format(sum_line_macaukombinasi)}</span></div>
                    </div>
                </div>
            {/if}
        {:else}
            ...
            {#if panel_line}
                <div class="bg-base-300 shadow-lg p-2">
                    ...
                    <div class="grid grid-cols-1">
                        <div class="basis-1/4 text-[11px]">MACAU KOMBINASI : <span class="text-[11px] link-accent">{count_line_macaukombinasi}</span></div>
                    </div>
                </div>
            {/if}
            {#if panel_sum}
                <div class="bg-base-300 shadow-lg p-2">
                    ...
                    <div class="grid grid-cols-1">
                        <div class="basis-1/4 text-[11px]">MACAU KOMBINASI : <span class="text-[11px] link-accent">{new Intl.NumberFormat().format(sum_line_macaukombinasi)}</span></div>
                    </div>
                </div>
            {/if}
    ...
    <div class="modal " on:click|self={()=>isModalInformation = false}>
        <div class="modal-box relative max-w-full  w-full h-screen  rounded-none  p-0 m-0 overflow-hidden">
            <div class="border-b-2 border-base-200 p-2 h-11 w-full max-w-full">
                <label for="my-modal-information" class="btn btn-sm btn-circle absolute right-2 top-2">✕</label>
                <h3 class="text-xs lg:text-sm font-bold mt-2">INFORMASI: KOMBINASI</h3>
            </div>
                        ...
                        <table class="table table-compact w-full" >
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-[11px] text-right link-accent">{(diskon_bet *100).toFixed(2)}%</td>
                                </tr>
                                <tr>
                                    <td class="text-[11px] text-left">HADIAH</td>
                                    <td class="text-[11px] text-right link-accent">{win_bet.toFixed(2)}x</td>
                                </tr>
                            </tbody>
                        </table>    
                    </div>
