        ...
        {:else}
            ...
            {#if panel_line}
                <div class="bg-base-300 shadow-lg p-2">
                    ...
                    <div class="grid grid-cols-2">
                        <div class="basis-1/4 text-[11px]">COLOK BEBAS : <span class="text-[11px] link-accent">{count_line_colokbebas}</span></div>
                        <div class="basis-1/4 text-[11px]">COLOK MACAU : <span class="text-[11px] link-accent">{count_line_colokmacau}</span></div>
                        <div class="basis-1/4 text-[11px]">COLOK NAGA : <span class="text-[11px] link-accent">{count_line_coloknaga}</span></div>
                        <div class="basis-1/4 text-[11px]">COLOK JITU : <span class="text-[11px] link-accent">{count_line_colokjitu}</span></div>
                    </div>
                </div>
            {/if}
            {#if panel_sum}
                <div class="bg-base-300 shadow-lg p-2">
                    ...
                    <div class="grid grid-cols-2">
                        <div class="basis-1/4 text-[11px]">COLOK BEBAS : <span class="text-[11px] link-accent">{new Intl.NumberFormat().format(sum_colokbebas)}</span></div>
                        <div class="basis-1/4 text-[11px]">COLOK MACAU : <span class="text-[11px] link-accent">{new Intl.NumberFormat().format(sum_colokmacau)}</span></div>
                        <div class="basis-1/4 text-[11px]">COLOK NAGA : <span class="text-[11px] link-accent">{new Intl.NumberFormat().format(sum_coloknaga)}</span></div>
                        <div class="basis-1/4 text-[11px]">COLOK JITU : <span class="text-[11px] link-accent">{new Intl.NumberFormat().format(sum_colokjitu)}</span></div>
                    </div>
                </div>
            {/if}
        {/if}
